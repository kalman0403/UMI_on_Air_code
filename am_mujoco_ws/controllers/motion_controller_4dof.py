...
class UAM4DoFMotionController():
    ...
    def __init__(self, start_time = 0.0):
        ...
        # zero gravity
        # self.uav_controller_px = pid_controller.PID(Kp=100.0, Ki=50.0, Kd=25.0, setpoint=0, start_time=start_time, output_limits=(None, None))
        # self.uav_controller_py = pid_controller.PID(Kp=100.0, Ki=50.0, Kd=25.0, setpoint=0, start_time=start_time, output_limits=(None, None))
        # self.uav_controller_pz = pid_controller.PID(Kp=100.0, Ki=50.0, Kd=25.0, setpoint=0, start_time=start_time, output_limits=(None, None))
        ...
        # self.manipulator_controller_link1_pitch = pid_controller.PID(Kp=0.7, Ki=0.1, Kd=0.4, setpoint=0, start_time=start_time, output_limits=(-1, 1))
        # self.manipulator_controller_link2_pitch = pid_controller.PID(Kp=0.3, Ki=0.1, Kd=0.15, setpoint=0, start_time=start_time, output_limits=(-1, 1))
        # self.manipulator_controller_link3_pitch = pid_controller.PID(Kp=0.1, Ki=0.1, Kd=0.02, setpoint=0, start_time=start_time, output_limits=(-1, 1))
        # self.manipulator_controller_link4_roll = pid_controller.PID(Kp=0.1, Ki=0.01, Kd=0.01, setpoint=0, start_time=start_time, output_limits=(-1, 1))
        # normal gravity
        ...
        self.uav_controller_roll = pid_controller.PID(Kp=100.0, Ki=20.0, Kd=3.0, setpoint=0, start_time=start_time, output_limits=(None, None))
        self.uav_controller_pitch = pid_controller.PID(Kp=100.0, Ki=20.0, Kd=3.0, setpoint=0, start_time=start_time, output_limits=(None, None))
        self.uav_controller_yaw = pid_controller.PID(Kp=100.0, Ki=20.0, Kd=3.0, setpoint=0, start_time=start_time, output_limits=(None, None))
        self.manipulator_controller_link1_pitch = pid_controller.PID(Kp=1.5, Ki =0.2, Kd=0.5, setpoint=0, start_time=start_time, output_limits=(-1, 1))
        self.manipulator_controller_link2_pitch = pid_controller.PID(Kp=1.5, Ki=0.2, Kd=0.5, setpoint=0, start_time=start_time, output_limits=(-1, 1))
        self.manipulator_controller_link3_pitch = pid_controller.PID(Kp=0.3, Ki=0.05, Kd=0.05, setpoint=0, start_time=start_time, output_limits=(-1, 1))
        # self.manipulator_controller_link3_pitch = pid_controller.PID(Kp=0.2, Ki=0.05, Kd=0.05, setpoint=0, start_time=start_time, output_limits=(-1, 1))
        self.manipulator_controller_link4_roll = pid_controller.PID(Kp=0.03, Ki=0.03, Kd=0.01, setpoint=0, start_time=start_time, output_limits=(-1, 1))
    ...
    def set_target(self, target):
        ...
        self.manipulator_controller_link3_pitch.setpoint(target[8])
        self.manipulator_controller_link4_roll.setpoint(target[9])
        if target.shape[0] >10:
            self.gripper_status_target = target[10]

    def get_control(self, current_state, current_time):
        # input: current state = [base_x, base_y, base_z,
        #                         base_roll, base_pitch, base_yaw,
        #                         link1_pitch, link2_pitch, link3_pitch, link4_roll,
        ...
        manipulator_control = np.array([
                                        ...
                                        self.manipulator_controller_link3_pitch.get_control(current_state[8], current_time),
                                        self.manipulator_controller_link4_roll.get_control(current_state[9], current_time)])
