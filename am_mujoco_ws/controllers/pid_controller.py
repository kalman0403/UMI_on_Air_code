...
class PID():
    ...
    def get_control (self, input_, current_time = None, dt=None):
        """
        ...
        if current_time is None and dt is None:
            raise ValueError('Either current_time or dt must be set')
        ...
        if dt < 0:
            print("now", now)
            print("self._last_time", self._last_time)
