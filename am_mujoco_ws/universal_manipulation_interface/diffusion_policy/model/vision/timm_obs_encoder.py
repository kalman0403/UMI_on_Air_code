...
class TimmObsStateEncoder(ModuleAttrMixin):
    def __init__(self,
            shape_meta: dict,
            model_name: str,
            pretrained: bool,
        ...
        # Add a default image shape if none is found
        if image_shape is None:
            image_shape = (224, 224, 3)  # Default size for vision models
            print("No RGB observations found. Using default image shape:", image_shape)
