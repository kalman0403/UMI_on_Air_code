...
from diffusion_policy.policy.diffusion_unet_state_policy import DiffusionUnetTimmStatePolicy
...
class TrainDiffusionUnetStateWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: DiffusionUnetTimmStatePolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: DiffusionUnetTimmStatePolicy = None
...
def main(cfg):
    workspace = TrainDiffusionUnetStateWorkspace(cfg)
    workspace.run()
